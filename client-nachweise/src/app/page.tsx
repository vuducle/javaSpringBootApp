...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 font-sans dark:bg-zinc-800">
      <header className="flex w-full items-center justify-end p-4 gap-2">
        <LanguageSwitcher />
        <ThemeToggleButton />
      </header>
